...
if ( ! defined( 'BSEOP_PLUGIN_LANG_DIR' ) )
    define( 'BSEOP_PLUGIN_LANG_DIR', BSEOP_PLUGIN_DIRNAME . '/lang' );
    
function basic_seo_lang_loader() {
	load_plugin_textdomain( 'basic-seo-pack', false, BSEOP_PLUGIN_LANG_DIR ); 
}
add_action('plugins_loaded', 'basic_seo_lang_loader');
...
class BasicSEO {
	...
	function save_postdata($post_id) {
		...
		// check for metabox existence
		if ( !isset($_POST[BasicSEO::$prefix . 'meta_box_nonce']) ) {
			return $post_id;
		} // end if
